...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_planck_mit(
    ...
    KC_LCTL, KC_LALT, KC_LGUI,  MT(MOD_LSFT | MOD_LALT | MOD_LGUI, SE_LESS),    MO(1),    KC_SPACE,    LALT(KC_4),  SE_LCBR_MAC, SE_RCBR_MAC,   LALT(KC_2), SE_QUES
  ),

 [1] = LAYOUT_planck_mit(
    KC_GRAVE,  LSFT(KC_1), LSFT(KC_2), LSFT(KC_3), LSFT(KC_4), LSFT(KC_5),  LSFT(KC_6),  LSFT(KC_7),  LSFT(KC_8),  LSFT(KC_9),  LSFT(KC_0),  SE_AE,
    KC_TAB,  SE_PIPE_MAC,  ___,  ___,   ___,  ___,  SE_GRV_MAC,  SE_BSLS_MAC,  SE_LBRC,   SE_RBRC,  SE_OSLH, SE_AA,
